...
from .views import  (registration_view,RetrieveUpdateDestroyAPIView, BooksAuthorAPIView, BooksAPIView, 
                     GenreAPIView, FilterBooksAPIView, DjangoFilterBooksAPIView, SearchBooksAPIView)
...
urlpatterns = [
    ...
    path("search-books/", SearchBooksAPIView.as_view() , name='search-books'), 
